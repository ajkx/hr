...
<script>
    ...
    $('table[grid-manager="main"]').GM({
        ...
        supportSorting: true,
        isCombSorting: true,
        ajax_url: '/attendance/customholiday/list',
        ajax_type: 'GET',
        pageSize: 10,
        height:"auto",
        columnData: [
            ...
            },
            {
                ...
                template:function(id,rowObject){
                    return '<div><a <shiro:lacksPermission name="CustomHoliday:update">disable=""</shiro:lacksPermission> class="font-color" href="javascript:void(0)" onclick="showEditModal(\'/attendance/customholiday/'+id+'/update\')">编辑</a><span class="ant-divider"></span><a <shiro:lacksPermission name="CustomHoliday:delete">disable=""</shiro:lacksPermission> class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/attendance/customholiday/'+id+'/delete\')">删除</a> </div>';
                }
            }
        ]
    });
...
<div class="topic-toolbar">
    <a style="font-size: 14px;color:#2db7f5" href="javascript:void(0)"
       onclick="showEditModal('/attendance/customholiday/create')">新增节假日</a>
